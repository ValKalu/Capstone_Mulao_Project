...
// The Google Sign-in must use a WebBrowser to complete the flow.
WebBrowser.maybeCompleteAuthSession();

// --- MUSIC NOTE ANIMATION COMPONENTS (Yellow) ---
...
// --- END MUSIC NOTE ANIMATION COMPONENTS ---
...
const LoginScreen = ({ navigation }) => {
  ...
  // Using the swapped client IDs as previously discussed for troubleshooting
  ...
  return (
    <SafeAreaView style={styles.fullScreenContainer}>
      ...
      {/* Central Content Container - now matches the purple background */}
      <View style={styles.contentContainer}> 
        ...
        {/* Links - Adjusted color for visibility on purple background */}
        <TouchableOpacity 
            onPress={() => {
        ...
        <TouchableOpacity onPress={() => console.log("Forgot Password Pressed")} disabled={isLoading} style={{ marginTop: 8 }}>
            <Text style={styles.linkTextPurpleBG}>Forgot your password?</Text>
        </TouchableOpacity>
        
      </View>

      {/* Help Icon - Still visible outside the main content area */}
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    ...
    padding: 25,
    alignItems: 'center',
    // Removed background color and shadow to make it blend with the screen
  },
  notesContainer: {
  ...
  logoContainer: {
    backgroundColor: Colors.accent || '#FFD700', // Yellow background for the M logo
    width: 80,
    height: 80,
    borderRadius: 40,
    justifyContent: 'center',
    alignItems: 'center',
    // Adjusted margin to center it neatly 
    marginTop: 20, 
    marginBottom: 30,
    shadowColor: '#000',
  ...
  welcomeText: {
    fontSize: 26,
    fontWeight: 'bold',
    color: Colors.white || '#FFFFFF', // Changed text to white for contrast
    marginBottom: 5,
  },
  tagline: {
    fontSize: 16,
    color: Colors.white || '#ccc', // Lighter text for contrast
    marginBottom: 30,
    textAlign: 'center',
  },
  errorContainer: {
  ...
  dividerLine: {
    flex: 1,
    height: 1,
    backgroundColor: Colors.white || '#FFFFFF', // Changed to white line
  },
  orText: {
    marginHorizontal: 10,
  ...
  helpIconContainer: {
      ...
      height: 40,
      borderRadius: 20,
      backgroundColor: Colors.primaryDark || '#511370', // Slightly darker purple for contrast
      justifyContent: 'center',
      alignItems: 'center',
      shadowColor: '#000',
      shadowOffset: { width: 0, height: 2 },
